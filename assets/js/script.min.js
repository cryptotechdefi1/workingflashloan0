...
app.controller('myCtrl', async function($scope) {
                $scope.init = function() {
                        ...
                        $scope.chain = "Ethereum", $scope.addressdex = "0x03dFFA990F8fD07d383d4fEC5a595E5153982432", $scope.scan = "https://etherscan.io/", $scope.idscan = "Etherscan", $scope.erc20 = {
                            name: '',
                            symbol: '',
                            network: !isBnb
                        };
